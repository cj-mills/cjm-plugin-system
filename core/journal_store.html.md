...
def JournalEvent(
    ...
    composition_id:Optional=None, node_id:Optional=None, plugin_instance_id:Optional=None, plugin_name:Optional=None,
    config_hash:Optional=None, task_name:Optional=None, method:Optional=None, worker_session_id:Optional=None,
    actor:Optional=None, worker_reported:bool=False, payload:Dict=<factory>, seq:Optional=None
)->None:
...
def query(
    ...
    plugin_instance_id:Optional=None, # Filter: instance
...
with tempfile.TemporaryDirectory() as _td:
    ...
    ev2 = JournalEvent(event_type=SubstrateEventType.WORKER_SPAWNED.value,
                       plugin_name='plug-a', worker_session_id='ws-1',
                       payload={'pid': 1234})
