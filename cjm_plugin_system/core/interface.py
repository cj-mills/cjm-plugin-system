...
# %% auto #0
__all__ = ['RELOAD_TRIGGER', 'WORKER_ENV_TEMPLATE_PLACEHOLDERS', 'FileBackedDTO', 'ConfigOption', 'FieldOptions', 'EnvVarSpec',
           'expand_worker_env_template', 'template_check_placeholders', 'PluginInterface', 'plugin_action',
...
# %% ../../nbs/core/interface.ipynb #cr11dc01
...
# %% ../../nbs/core/interface.ipynb #da9319fb
@dataclasses.dataclass
class EnvVarSpec:
...
# %% ../../nbs/core/interface.ipynb #af6757b8
...
# %% ../../nbs/core/interface.ipynb #548ddb70
...
PluginInterface.report_progress = _report_progress_threadsafe
...
PluginInterface.heartbeat = _heartbeat
