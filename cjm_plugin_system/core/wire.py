...
# %% auto #0
__all__ = ['WIRE_KIND_KEY', 'WIRE_DATA_KEY', 'ENVELOPE_BODY_KEY', 'FileBackedDTO', 'flat_from_dict', 'wire_type', 'wire_encode',
           'wire_decode', 'CallEnvelope', 'set_call_envelope', 'reset_call_envelope', 'get_call_envelope']
